...
export const UserGroupIcon: React.FC<{className?: string}> = ({ className = "h-5 w-5" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M18 18.72a9.094 9.094 0 003.75-5.25M18 18.72a9.094 9.094 0 01-3.75 5.25m-3.75-5.25a9.094 9.094 0 013.75-5.25m-3.75 5.25a9.094 9.094 0 00-3.75 5.25m9.75-9.75a9.094 9.094 0 00-3.75-5.25M12 3.75a9.094 9.094 0 013.75 5.25m-3.75 5.25a3 3 0 11-6 0 3 3 0 016 0z" />
    </svg>
);
